...
//de dias pecorridos desde 01/01/2017
//
...
namespace Ex33labex1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("a quantidade de dias pecorridos desde 01/01/2017 é : "+DataDiferenca(dia, mes, ano)+" dias");

        }

        static double DataDiferenca(int dia, int mes, int ano)
        {
            double somadia = 0;
            double somames = 0;
            double somaano = 0;
            ...
            if (ano>2016){
                ...
                else
                {
                    ...
                    if ((ano != 2017) && (ano > 2017))
                    {
                        ...
                        somaano = (ano * 366) + somames;
                        somames = 0;
                    }
                }

               contadias = somadia + somames + somaano;
            }

            else
            {
            Console.WriteLine("ano iferior a 2017");
            contadias=0;
            }
           return contadias;
        }
